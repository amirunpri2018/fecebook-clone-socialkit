...
function SK_isLogged() {
    ...
    if (!empty($_SESSION['user_id']) && is_numeric($_SESSION['user_id']) && $_SESSION['user_id'] > 0 && !empty($_SESSION['user_pass'])) {
        ...
        $query = "SELECT id FROM " . DB_ACCOUNTS . " WHERE id=$user_id AND password='$user_pass' AND type='user' AND active=1";
...
function SK_getUser($timeline_id=0, $all=false) {
    ...
    if (mysqli_num_rows($sql_query_two) == 1) {
        ...
        if (isset($sql_fetch_two['last_logged'])) {
            ...
            if (SK_isLogged() == true && $sql_fetch_two['last_logged'] > (time()-15)) {
                $sql_fetch_two['online'] = true;
            }
        }
        
        if ($sql_fetch_two['type'] == "user") {
            $subquery_one = 'gender,comment_privacy,follow_privacy,message_privacy,confirm_followers';
...
function SK_getStories($data=array('type' => 'all', 'after_post_id' => 0, 'publisher_id' => 0, 'limit' => 5)) {
    ...
    if (!empty($data['publisher_id']) && is_numeric($data['publisher_id']) && $data['publisher_id'] > 0) {
        ...
        $sk_publisher = SK_getUser($data['publisher_id']);
    }
    ...
    if (isset($sk_publisher['id'])) {
        ...
        if ($sk_publisher['type'] == "user") {
            switch ($data['type']) {
                ...
                default:
                    $query_text .= " AND (timeline_id=" . $data['publisher_id'] . " OR recipient_id=" . $data['publisher_id'] . ") AND hidden=0 AND type1='story' AND type2 IN ('none','share')";
            }
        ...
        switch ($data['type']) {
            case 'texts':
                $query_text .= " AND (timeline_id IN (SELECT following_id FROM " . DB_FOLLOWERS . " WHERE follower_id=" . $user['id'] . " AND active=1) OR recipient_id IN (SELECT following_id FROM " . DB_FOLLOWERS . " WHERE follower_id=" . $user['id'] . " AND following_id IN (SELECT id FROM " . DB_GROUPS . "))) AND google_map_name='' AND media_id=0 AND soundcloud_uri='' AND youtube_video_id='' AND hidden=0 AND type1='story' AND type2='none'";
            break;
            
            case 'photos':
                $query_text .= " AND (timeline_id IN (SELECT following_id FROM " . DB_FOLLOWERS . " WHERE follower_id=" . $user['id'] . " AND active=1) OR recipient_id IN (SELECT following_id FROM " . DB_FOLLOWERS . " WHERE follower_id=" . $user['id'] . " AND following_id IN (SELECT id FROM " . DB_GROUPS . "))) AND media_id>0 AND hidden=0 AND type1='story' AND type2='none'";
            break;
            
            case 'videos':
                $query_text .= " AND (timeline_id IN (SELECT following_id FROM " . DB_FOLLOWERS . " WHERE follower_id=" . $user['id'] . " AND active=1) OR recipient_id IN (SELECT following_id FROM " . DB_FOLLOWERS . " WHERE follower_id=" . $user['id'] . " AND following_id IN (SELECT id FROM " . DB_GROUPS . "))) AND youtube_video_id<>'' AND hidden=0 AND type1='story' AND type2='none'";
            break;
            
            case 'music':
                $query_text .= " AND (timeline_id IN (SELECT following_id FROM " . DB_FOLLOWERS . " WHERE follower_id=" . $user['id'] . " AND active=1) OR recipient_id IN (SELECT following_id FROM " . DB_FOLLOWERS . " WHERE follower_id=" . $user['id'] . " AND following_id IN (SELECT id FROM " . DB_GROUPS . "))) AND soundcloud_uri<>'' AND hidden=0 AND type1='story' AND type2='none'";
            break;
            
            case 'places':
                $query_text .= " AND (timeline_id IN (SELECT following_id FROM " . DB_FOLLOWERS . " WHERE follower_id=" . $user['id'] . " AND active=1) OR recipient_id IN (SELECT following_id FROM " . DB_FOLLOWERS . " WHERE follower_id=" . $user['id'] . " AND following_id IN (SELECT id FROM " . DB_GROUPS . "))) AND google_map_name<>'' AND hidden=0 AND type1='story' AND type2='none'";
            break;
            
            case 'likes':
                $query_text .= " AND (timeline_id IN (SELECT following_id FROM " . DB_FOLLOWERS . " WHERE follower_id=" . $user['id'] . " AND active=1) OR recipient_id IN (SELECT following_id FROM " . DB_FOLLOWERS . " WHERE follower_id=" . $user['id'] . " AND following_id IN (SELECT id FROM " . DB_GROUPS . "))) AND hidden=0 AND type1='story' AND type2='like'";
            break;
            
            case 'shares':
                $query_text .= " AND (timeline_id IN (SELECT following_id FROM " . DB_FOLLOWERS . " WHERE follower_id=" . $user['id'] . " AND active=1) OR recipient_id IN (SELECT following_id FROM " . DB_FOLLOWERS . " WHERE follower_id=" . $user['id'] . " AND following_id IN (SELECT id FROM " . DB_GROUPS . "))) AND hidden=0 AND type1='story' AND type2='share'";
            break;
            
            default:
                $query_text .= " AND (timeline_id IN (SELECT following_id FROM " . DB_FOLLOWERS . " WHERE follower_id=" . $user['id'] . " AND active=1) OR recipient_id IN (SELECT following_id FROM " . DB_FOLLOWERS . " WHERE follower_id=" . $user['id'] . " AND following_id IN (SELECT id FROM " . DB_GROUPS . "))) AND hidden=0 AND type1='story' AND type2 IN ('none','share','like')";
        }
    }
...
function SK_getStory($story_id=0, $view_all_comments=false) {
    ...
    $query_one = "SELECT id,active,google_map_name,hidden,link_title,link_url,media_id,post_id,recipient_id,soundcloud_title,soundcloud_uri,text,time,timeline_id,type1,type2,youtube_video_id,youtube_title FROM " . DB_POSTS . " WHERE id=$story_id AND type1='story' AND active=1";
    $sql_query_one = mysqli_query($dbConnect, $query_one);
    ...
    if (mysqli_num_rows($sql_query_one) == 1) {
        ...
        if ($post['id'] == $post['post_id']) { 
            ...
            $query_two = "SELECT id,active,google_map_name,hidden,link_title,link_url,media_id,post_id,recipient_id,soundcloud_title,soundcloud_uri,text,time,timeline_id,type1,type2,youtube_video_id,youtube_title FROM " . DB_POSTS . " WHERE id=" . $post['post_id'] . " AND type1='story' AND type2='none' AND active=1";
            $sql_query_two = mysqli_query($dbConnect, $query_two);
        ...
        if ($story['media_id'] > 0 && mysqli_num_rows($sql_query_three) > 0) {
            ...
            $query_four = "SELECT id,type FROM " . DB_MEDIA . " WHERE id=" . $story['media_id'] . " AND active=1";
            ...
            if ($sql_fetch_four['type'] == "photo") {
                ...
                $story['media'][] = array(
                    ...
                    'url' => $sk['config']['site_url'] . '/' . $sql_fetch_four['url'] . '_100x75.' . $sql_fetch_four['extension'],
                    'post_url' => SK_smoothLink('index.php?tab1=story&id=' . $story['id'])
                );
            } elseif ($sql_fetch_four['type'] == "album") {
                $query_five = "SELECT id FROM " . DB_MEDIA . " WHERE album_id=" . $sql_fetch_four['id'] . " AND active=1";
    ...
    if ($hashtag == true) {
        ...
        foreach ($matches[1] as $match) {
            ...
            if (is_array($hashdata)) {
                $hashlink = '<a href="' . SK_smoothLink('index.php?tab1=hashtag&query=' . $hashdata['tag']) . '">#' . $hashdata['tag'] . '</a>';
    ...
    if ($mention == true) {
        ...
        if (preg_match_all($mention_regex, $text, $matches)) {
            ...
            foreach ($matches[1] as $match) {
                ...
                $match_search = '@[' . $match . ']';
                $match_replace = '<a href="' . $match_user['url'] . '">' . $match_user['name'] . '</a>';
...
function SK_countNotifications($data=array()) {
    ...
    $query_one = "SELECT id FROM " . DB_NOTIFICATIONS . " WHERE timeline_id=" . $account['id'] . " AND active=1";
    ...
    return mysqli_num_rows($sql_query_one);
}
...
function SK_countFollowing($timeline_id=0) {
    ...
    $timeline_id = SK_secureEncode($timeline_id);
    $query = "SELECT id FROM " . DB_ACCOUNTS . " WHERE id IN (SELECT following_id FROM " . DB_FOLLOWERS . " WHERE follower_id=$timeline_id AND following_id<>$timeline_id AND active=1) AND type='user' AND active=1";
    $sql_query = mysqli_query($dbConnect, $query);
...
function SK_countFollowers($timeline_id=0) {
    ...
    $timeline_id = SK_secureEncode($timeline_id);
    $query = "SELECT id FROM " . DB_ACCOUNTS . " WHERE id IN (SELECT follower_id FROM " . DB_FOLLOWERS . " WHERE following_id=$timeline_id AND follower_id<>$timeline_id AND active=1) AND active=1";
    $sql_query = mysqli_query($dbConnect, $query);
...
function SK_countPageLikes($timeline_id=0) {
    ...
    $timeline_id = SK_secureEncode($timeline_id);
    $query = "SELECT id FROM " . DB_ACCOUNTS . " WHERE id IN (SELECT following_id FROM " . DB_FOLLOWERS . " WHERE follower_id=$timeline_id AND following_id<>$timeline_id AND active=1) AND type='page' AND active=1";
    $sql_query = mysqli_query($dbConnect, $query);
...
function SK_countGroupJoined($timeline_id=0) {
    ...
    $timeline_id = SK_secureEncode($timeline_id);
    $query = "SELECT id FROM " . DB_ACCOUNTS . " WHERE id IN (SELECT following_id FROM " . DB_FOLLOWERS . " WHERE follower_id=$timeline_id AND following_id<>$timeline_id AND active=1) AND type='group' AND active=1";
    $sql_query = mysqli_query($dbConnect, $query);
...
function SK_countFollowRequests($timeline_id=0) {
    ...
    $timeline_id = SK_secureEncode($timeline_id);
    $query = "SELECT id FROM " . DB_ACCOUNTS . " WHERE id IN (SELECT follower_id FROM " . DB_FOLLOWERS . " WHERE following_id=$timeline_id AND follower_id<>$timeline_id AND active=0) AND active=1";
    $sql_query = mysqli_query($dbConnect, $query);
...
function SK_countPageAdmins($page_id=0) {
    ...
    $page_id = SK_secureEncode($page_id);
    $query = "SELECT DISTINCT admin_id FROM " . DB_PAGE_ADMINS . " WHERE page_id=$page_id AND active=1";
    $sql_query = mysqli_query($dbConnect, $query);
...
function SK_countGroupAdmins($group_id=0) {
    ...
    $group_id = SK_secureEncode($group_id);
    $query = "SELECT DISTINCT admin_id FROM " . DB_GROUP_ADMINS . " WHERE group_id=$group_id AND active=1";
    $sql_query = mysqli_query($dbConnect, $query);
...
function SK_countOnlines($timeline_id=0) {
    ...
    $query_text = "SELECT id FROM " . DB_ACCOUNTS . " WHERE id IN (SELECT following_id FROM " . DB_FOLLOWERS . " WHERE follower_id=$timeline_id AND following_id<>$timeline_id AND active=1) AND type='user' AND last_logged>" . (time()-15) . " AND active=1 ORDER BY last_logged DESC";
    $sql_query = mysqli_query($dbConnect, $query_text);
...
function SK_countMessages($data=array()) {
    ...
    if (isset($data['recipient_id']) && is_numeric($data['recipient_id']) && $data['recipient_id'] > 0) {
        ...
        if (isset($data['new']) && $data['new'] == true) {
            $query = "SELECT id FROM " . DB_POSTS . " WHERE type1='message' AND active=1 AND timeline_id=" . $data['recipient_id'] . " AND recipient_id=" . $timeline['id'];
        } else {
            $query = "SELECT id FROM " . DB_POSTS . " WHERE type1='message' AND active=1 AND ((timeline_id=" . $data['recipient_id'] . " AND recipient_id=" . $timeline['id'] . ") OR (timeline_id=" . $timeline['id'] . " AND recipient_id=" . $data['recipient_id'] . "))";
        }
    } else {
        $query = "SELECT DISTINCT timeline_id FROM " . DB_POSTS . " WHERE type1='message' AND active=1 AND recipient_id=" . $timeline['id'];
    }
...
function SK_countPosts($timeline_id=0) {
    ...
    $query = "SELECT id FROM " . DB_POSTS . " WHERE $subquery AND type1='story' AND type2='none' AND hidden=0 AND active=1";
    $sql_query = mysqli_query($dbConnect, $query);
...
function SK_countPostLikes($post_id=0) {
    ...
    $query_one = "SELECT id FROM " . DB_POSTS . " WHERE post_id=$post_id AND type2='like' AND active=1";
    $sql_query_one = mysqli_query($dbConnect, $query_one);
...
function SK_countPostCommenters($post_id=0) {
    ...
    $query_one = "SELECT DISTINCT timeline_id FROM ". DB_POSTS ." WHERE post_id=$post_id AND type1='story' AND type2='comment' AND active=1";
    $sql_query_one = mysqli_query($dbConnect, $query_one);
    return mysqli_num_rows($sql_query_one);
}
...
function SK_countPostShares($post_id=0) {
    ...
    $query_one = "SELECT id FROM " . DB_POSTS . " WHERE post_id=$post_id AND type1='story' AND type2='share' AND active=1";
    $sql_query_one = mysqli_query($dbConnect, $query_one);
    return mysqli_num_rows($sql_query_one);
}
...
function SK_countPostFollows($post_id=0) {
    ...
    $query_one = "SELECT id FROM " . DB_POSTS . " WHERE post_id=$post_id AND type1='story' AND type2='follow' AND active=1";
    $sql_query_one = mysqli_query($dbConnect, $query_one);
    return mysqli_num_rows($sql_query_one);
}
        ...
        if (isset($post['id'])) {
            ...
            if ($type == "like") {
                ...
                if ($post['timeline_id'] == $recipient['id']) {
                    $text .= 'likes your post "' . substr($post['text'],0,45) . '..."';
                }
            }
            ...
            if ($type == "comment") {
                ...
                if ($post['timeline_id'] == $recipient['id']) {
                    $text .= 'commented on your post "' . substr($post['text'],0,45) . '..."';
                } else {
                    $post['timeline'] = SK_getUser($post['timeline_id']);
                    $text .= 'commented on ' . $post['timeline']['name'] . '&#39;s post "' . substr($post['text'],0,45) . '..."';
                }
            }
            ...
            if ($type == "share") {
                ...
                if ($post['timeline_id'] == $recipient['id']) {
                    $text .= 'shared your post "' . substr($post['text'],0,45) . '..."';
                }
            }
        } else {
...
function SK_registerUser($data=0) {
    ...
    if (!empty($data['name']) && !empty($data['username']) && !empty($data['email']) && !empty($data['password']) && !empty($data['gender'])) {
        ...
        $query_one = "INSERT INTO " . DB_ACCOUNTS . " (active,cover_id,email,email_verification_key,name,password,time,type,username) VALUES (1,0,'$email','" . md5(SK_generateKey()) . "','$name','$md5_password'," . time() . ",'user','$username')";
        $sql_query_one = mysqli_query($dbConnect, $query_one);
        
        if ($sql_query_one) {
            $user_id = mysqli_insert_id($dbConnect);
            $query_two = "INSERT INTO " . DB_USERS . " (id,gender) VALUES ($user_id,'$gender')";
            $sql_query_two = mysqli_query($dbConnect, $query_two);
...
function SK_registerFollow($following_id=0, $timeline_id=0) {
    ...
    if ($following['type'] == "group" && $following['group_privacy'] == "secret") {
        return false;
    }
    ...
    if ($following['type'] == "group" && $following['group_privacy'] == "closed" && !SK_isGroupAdmin($following['id'])) {
        $active = 0;
    }
    ...
    if (SK_isPageAdmin($page_id, $admin_id)) {
        ...
        if ($sql_query_one) {
            $notification_data_array = array(
                ...
                'notifier_id' => $page['id'],
                'type' => 'page_add_admin',
                'text' => 'made you an admin of their Page',
        ...
        if (SK_isFollowRequested($group['id'], $member['id'])) {
            ...
            if ($sql_query_one) {
                $notification_data_array = array(
                    ...
                    'text' => 'accepted your request to join the group [b weight=500]'. $group['name'] .'[/b]',
            ...
            if ($sql_query_one) {
                $notification_data_array = array(
                    'recipient_id' => $member['id'],
                    'text' => 'added you to the group [b weight=500]'. $group['name'] .'[/b]',
                    'type' => 'made_group_member',
                    'url' => 'index.php?tab1=timeline&id=' . $group['username']
                );
                SK_registerNotification($notification_data_array);
...
function SK_registerGroupAdmin($group_id=0, $admin_id=0) {
    ...
    if ($sql_query_one) {
        $notification_data_array = array(
            ...
            'text' => 'made you an admin of the group [b weight=500]'. $group['name'] .'[/b]',
...
function SK_processMedia($run, $photo_src, $save_src, $width=0, $height=0) {
