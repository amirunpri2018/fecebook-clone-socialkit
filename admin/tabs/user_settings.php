    ...
    <div class="content-wrapper">
        ...
        <div class="input float-left">
            <select name="comment_privacy">
                <option value="everyone" <?php if ($default_settings['comment_privacy'] == "everyone") echo 'selected'; ?>>Everyone</option>
                <option value="following" <?php if ($default_settings['comment_privacy'] == "following") echo 'selected'; ?>>Only people user follows</option>
            </select>
    ...
    <div class="content-wrapper">
        ...
        <div class="input float-left">
            <select name="confirm_followers">
                <option value="0" <?php if ($default_settings['confirm_followers'] == 0) echo 'selected'; ?>>No</option>
                <option value="1" <?php if ($default_settings['confirm_followers'] == 1) echo 'selected'; ?>>Yes</option>
            </select>
    ...
    <div class="content-wrapper">
        ...
        <div class="input float-left">
            <select name="follow_privacy">
                <option value="everyone" <?php if ($default_settings['follow_privacy'] == "everyone") echo 'selected'; ?>>Everyone</option>
                <option value="following" <?php if ($default_settings['follow_privacy'] == "following") echo 'selected'; ?>>Only people user follows</option>
            </select>
    ...
    <div class="content-wrapper">
        ...
        <div class="input float-left">
            <select name="message_privacy">
                ...
                <option value="following" <?php if ($default_settings['message_privacy'] == "following") echo 'selected'; ?>>Only people user follows</option>
            </select>
    ...
    <div class="content-wrapper">
        ...
        <div class="input float-left">
            <select name="timeline_post_privacy">
                ...
                <option value="following" <?php if ($default_settings['timeline_post_privacy'] == "following") echo 'selected'; ?>>Only people user follows</option>
                <option value="none" <?php if ($default_settings['timeline_post_privacy'] == "none") echo 'selected'; ?>>No one</option>
            </select>
